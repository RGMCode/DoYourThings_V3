    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                // Kategorie-Info mit Icon in der Kategorie-Farbe
                HStack {
                ...
                // Zusätzliche Informationen: Datum, Zeit, Reminder, Deadline
        ...
        .sheet(isPresented: $isPresentingEditView) {
            DoYourThingEditView(viewModel: viewModel, task: dyt, context: context)
        }
    }
    
    // Formatter für Datum und Uhrzeit
...
struct DoYourThingDetailView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let exampleTask = DoYourThing(
            ...
            dytDetailtext: "This is an example detail text for the task. It can be a longer description explaining all the important points of the task.",
            ...
            category: nil  // Setze hier bei Bedarf einen Dummy-Wert
        )
